...
export async function handleContractDeploy(args: { project_id: string; wallet_id: string; chain: "base-mainnet" | "base-sepolia"; bytecode: string; value?: string; idempotency_key?: string }): Promise<{ content: Array<{ type: "text"; text: string }>; isError?: boolean }> {
  try {
